...
describe('SignupService', () => {
  ...
  let controller: HttpTestingController; // permet le mocking et le flushing des requêtes
  ...
  beforeEach(() => {
    ...
    /*
    TestBed crée un module de test Angular construit dynamiquement qui émule un @NgModule Angular.
    */
    service = TestBed.inject(SignupService);
    controller = TestBed.inject(HttpTestingController); // HttpTestingController : capturer une requete
  });

  afterEach(() => {
    controller.verify(); // Vérifiez qu'aucune demande non appariée n'est en suspens.
  });
  ...
  it('checks if the username is taken', () => {
    ...
    /*
    S'attend à ce qu'aucune demande correspondant à l'URL donnée n'ait été effectuée.
    */
    ...
    request.flush({ usernameTaken: true }); // flush qui prend en argument la réponse que vous souhaitez fournir pour cette requête.
